        ...
        <div className="menu">
          ...
          <div className="courses">
            {cursos.map((value, index) => (
              ...
              >
                <h3>{value.titulo}</h3>
                <p className="displayMobile">
                  {value.duracao ? `Duração: ${value.duracao} anos` : ""}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="content">
          {cursos.map((value, index) => (
            <div key={`conteudo${index}`} className={"conteudo"}>
              ...
              <div
                className={cardSelect === index ? "info" : "disable"}
                key={`curso-info${index}`}
              >
                <Link passHref href={value.ppp ? value.ppp : "/"}>
                  <a>
                    <div>
                ...
                <Link
                  href={value.matrizCurricular ? value.matrizCurricular : "/"}
                  passHref
                >
                  <a>
                    <div>
                ...
                <Link href={value.ementario ? value.ementario : "/"} passHref>
                  <a>
                    <div>
                      <p>Ementário</p>
                      <p className="link">Ver mais</p>
                ...
                <Link
                  href={value.guiaEstudantil ? value.guiaEstudantil : "/"}
                  passHref
                >
                  <a>
                    <div>
